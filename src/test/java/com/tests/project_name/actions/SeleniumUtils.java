...
public class SeleniumUtils extends BasePage {
	 ...
	 *
	 * @param x Horizontal scroll amount (in pixels). Positive to scroll right,
	 *          negative to scroll left.
	 * @param y Vertical scroll amount (in pixels). Positive to scroll down,
	...
	// GENERATE RANDOM PASSWORD METHOD = ADDED BY MKB
	...
	// DATE OF BIRTH => SELECT RANDOM OPTION / ADDED BY MKB 
	public void selectRandomOption(WebElement dropdown) {
